...
namespace Splice.FxStudio
{
    ...
    public sealed class SpliceFxSubEffectDefinition : ScriptableObject
    {
        ...
        [Tooltip("Optional Sprite imported as Sprite (2D and UI). Supports a single sprite or a sub-sprite inside a sprite sheet/atlas.")]
        public Sprite sourceSprite;
        [Tooltip("Optional regular Texture2D source. Assign either Source Sprite or Source Texture.")]
        ...
        public Texture2D SourceTextureForProcessing =>
            sourceSprite != null ? sourceSprite.texture : sourceTexture;
        ...
        public Rect SourcePixelRect
        {
            get
            {
                var texture = SourceTextureForProcessing;
                ...
                try
                {
                    return sourceSprite.textureRect;
                }
                catch
                {
                    return sourceSprite.rect;
                }
            }
        }
        ...
        public Vector4 EffectiveTextureScaleOffset
        {
            get
            {
                var texture = EffectiveTexture;
                if (texture == null || processedTexture != null ||
                    sourceSprite == null)
                    return new Vector4(1f, 1f, 0f, 0f);
                var rect = SourcePixelRect;
                var width = Mathf.Max(1f, texture.width);
                var height = Mathf.Max(1f, texture.height);
                return new Vector4(
                    rect.width / width,
                    rect.height / height,
                    rect.x / width,
